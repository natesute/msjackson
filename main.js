...
/* ── Prebake: load all Strudel modules into eval scope ──── */
async function prebake() {
  ...
  await Promise.all([modulesLoading, registerSynthSounds()]);
}

/* ── Create the StrudelMirror editor ────────────────────── */
...
setStatus('Ready \u2014 click Play or press Ctrl+Enter');